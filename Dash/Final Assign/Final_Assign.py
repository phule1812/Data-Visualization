...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        R_chart2  = dcc.Graph(figure=px.line(average_sales,
                                    x='Vehicle_Type',
                                    y = 'Automobile_Sales',
                                    title='Auto Sales based on Vehicle Type'))
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(figure=px.pie(exp_rec,
                                ...
                                names='Vehicle_Type',
                                title='Advertising based on Vehicle Type during Recessions'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(figure=px.bar(unemp_rec,
                                x='unemployment_rate',
                                y='Automobile_Sales',
                                title='Effect of Unemployment on Auto Sales by Type'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
                                values='Advertising_Expenditure',
                                names='Vehicle_Type',
                                title='Advertising for each Vehicle Type'))
